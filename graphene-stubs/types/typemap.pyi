...
def resolve_type(
    resolve_type_func: Any, map: Any, type_name: Any, root: Any, info: Any
) -> Any: ...
def is_type_of_from_possible_types(
    possible_types: Any, root: Any, info: Any
) -> Any: ...
...
class TypeMap(GraphQLTypeMap):
    ...
    schema: Any = ...
    def __init__(
        self, types: Any, auto_camelcase: bool = ..., schema: Optional[Any] = ...
    ) -> None: ...
    def reducer(self, map: Any, type: Any) -> Any: ...
    ...
    def construct_fields_for_type(
        self, map: Any, type: Any, is_input_type: bool = ...
    ) -> Any: ...
    def get_resolver_for_type(
        self, type: Any, name: Any, default_value: Any
    ) -> Any: ...
